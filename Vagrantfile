...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", path: "script/utilitaires.sh"
  config.vm.provision "shell", path: "script/apache.sh"
  config.vm.provision "shell", path: "script/php72.sh"
  config.vm.provision "shell", path: "script/mariadb103.sh"
  ...
  config.vm.provision "shell", path: "script/rewriter.sh"
